...
This report documents a penetration testing engagement conducted against **{{ target_url }}** using the Connext Connext Security Platform. The assessment was performed on {{ started_at }} and completed on {{ completed_at }}.
...
**Report Generated by:** Connext Connext Security Platform v2.0  
**Timestamp:** {{ timestamp }}
...
<body>
    <div class="container">
        {{ content }}
        <div class="footer">
            <p><strong>Report Generated by:</strong> Connext Connext Security Platform v2.0</p>
    ...
    async def _generate_json_report(
        ...
        report_data = {
            "metadata": {
                ...
                "generator": "Connext Connext Security Platform v2.0",
                "format_version": "1.0"
            },
            "attack": attack_data,
            "results": results
