...
`hk` คือ AI Assistant แบบ CLI สำหรับโปรเจค Connext Security Platform ที่ออกแบบมาเพื่อใช้งานใน Sandbox โดยตรง
...
You: restart service connext-platform
```
...
You: ตรวจสอบสถานะโปรเจค Connext ทั้งหมด
