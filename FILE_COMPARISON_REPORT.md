# File Comparison Report: Root vs connext_FINAL

## Summary

- Common files: 276
- Files only in root: 216
- Files only in connext_FINAL: 6
...
| `api/routes/attack.py` | 238 | 304 | -66 | **Use connext_FINAL** |
...
| `api/license_routes.py` | 111 | 156 | -45 | **Use connext_FINAL** |
...
| `cli/attack_cli.py` | 462 | 480 | -18 | **Use connext_FINAL** |
...
| `agents/file_upload_agent.py` | 516 | 525 | -9 | **Use connext_FINAL** |
| `agents/active_directory/golden_ticket_agent.py` | 36 | 29 | +7 | Keep root |
| `core/vulnerability_scanner.py` | 322 | 329 | -7 | **Use connext_FINAL** |
| `agents/deserialization_exploiter.py` | 411 | 417 | -6 | **Use connext_FINAL** |
...
| `core/data_models.py` | 1077 | 1082 | -5 | **Use connext_FINAL** |
...
| `core/license_manager.py` | 293 | 296 | -3 | **Use connext_FINAL** |
| `core/nvd_client.py` | 81 | 78 | +3 | Keep root |
| `agents/exploit_agent.py` | 615 | 614 | +1 | Keep root |
| `ai_testing_system.py` | 607 | 608 | -1 | **Use connext_FINAL** |
| `cli/main.py` | 287 | 286 | +1 | Keep root |
| `core/agent_registry.py` | 95 | 96 | -1 | **Use connext_FINAL** |
