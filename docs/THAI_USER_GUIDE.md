# คู่มือปฏิบัติการ Connext Connext Framework (ภาษาไทย)
...
1.  **แตกไฟล์:** เริ่มต้นด้วยการแตกไฟล์ `connext_connext_framework_v3_final.zip` และเข้าไปยังไดเรกทอรีของโปรเจกต์
    ```bash
    unzip connext_connext_framework_v3_final.zip && cd connext_dlnk
    ```
...
คลังแสงของ Connext ประกอบด้วย Agent ที่ถูก "Weaponized" หรือติดอาวุธพร้อมใช้งานจริงจำนวน 12 หน่วย แต่ละหน่วยมีความเชี่ยวชาญเฉพาะทางและทำงานร่วมกันภายใต้การควบคุมของ Orchestrator เพื่อให้บรรลุภารกิจการเจาะระบบ
